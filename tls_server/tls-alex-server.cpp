...
#define keyFile "alex.key"
#define certFile "alex.crt"
#define caCert "signing.pem"
#define peerName "laptopcsr.com"
...
/* Old worker function from template code*/
...
// /* worker function from TCP/IP pdf */
// void *worker(void *conn) { 
// 	int exit = 0; 
// 	while(!exit) { 
// 	int count; 
...
int main()
{
	...
	createServer(keyFile, certFile, SERVER_PORT, &worker, caCert, peerName, 1);
