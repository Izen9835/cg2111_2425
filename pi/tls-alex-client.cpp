...
/* Constants used by createClient */
#define SERVER_NAME "192.168.252.99"  //static hostname worked on web browser
#define SERVER_PORT 5001
#define VERTIFY_SERVER 1
#define CA_CERT "signing.pem"
#define COMMON_NAME "mine.com"
...
int main(int ac, char **av)
{
	...
	createClient(SERVER_NAME, SERVER_PORT, 1, CA_CERT, COMMON_NAME, 1, CLIENT_CERT, CLIENT_KEY, readerThread, writerThread);
